...
export default function AddOrderItem({ id }: { id: string }) {
    ...
    const { currentFilter, currentSearch, handleChangeSearch, handleChangeFilter } = useDataTable();
    ...
    const handleAddToCart = (menu: Menu, action: 'increment' | 'decrement' ) => {
      ...
      setCarts([
        ...carts,{menu_id: menu.id, quantity: 1, nominal: priceAfterDiscount, notes: '', menu},
      ]);
    }
  };
      ...
      <div className="space-y-4 lg:w-2/3">
        <div className="flex flex-col items-center justify-between gap-4 w-full lg:flex-row">
          <div className="flex flex-col lg:flex-row items-center gap-4">
            <h1 className="text-2xl font-bold">メニュー | Menu</h1>
        ...
        {!isLoadingMenu && menus?.data?.length === 0 && (
          <div className="text-center w-full">メニューが見つかりません</div>
        )}
      </div>
