    ...
    return (
        <HoverCard>
            <HoverCardTrigger asChild>
                <div className={cn('bg-muted rounded-lg flex items-center justify-center outline-2 outline-offset-4 outline-dashed',
                    {
...
export default function TableMap({ tables, activeOrders,handleReservation}: {
    tables: TableMapType[];
    activeOrders: {
        order_id: string;
        customer_name: string;
